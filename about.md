...
#### Note:
The source codes for ui.R and server.R files are also available on the [GitHub repo](https://github.com/akhilapant/datasciencecapstone.git)

The presentation is available in [Rpubs](http://rpubs.com/akhilasaa/235936)
